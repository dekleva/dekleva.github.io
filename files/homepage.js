(this || self || window).Two = function (e) {
    ...
    var t = Object.prototype.toString,
        ...
        i = 0,
        o = B.natural.slice,
        s = p.performance && p.performance.now
            ? p.performance
            : Date,
        r = Math.pow(2, 53) - 1,
        g = function (e) {
            ...
            getRequestAnimationFrame: function () {
                ...
                if (!i) {
                    for (var r = 0; r < t.length; r++) 
                        ...
                        e = p[t[r] + "CancelAnimationFrame"] || p[t[r] + "CancelRequestAnimationFrame"] || e;
                    i = i || function (e, t) {
        ...
        O = p.Two = function (e) {
            ...
            this
                .renderer
                .bind(O.Events.resize, B.bind(C, this)),
    ...
    B.extend(O, {
        ...
        Utils: B.extend(B, {
            ...
            release: function (e) {
                if (B.isObject(e)) 
                    return B.isFunction(e.unbind) && e.unbind(),
                    e.vertices && (
            ...
            decomposeMatrix: function (e) {
                var t = O
                        .Utils
                        .deltaTransformPoint(e, 0, 1),
                    i = O
                        .Utils
                        .deltaTransformPoint(e, 1, 0),
            ...
            extractCSSText: function (e, t) {
                ...
                for (var o = 0; o < i.length; o++) 
                    n = (r = i[o].split(":"))[0],
                    s = r[1],
                    B.isUndefined(n) || B.isUndefined(s) || (t[n] = s.replace(/\s/, ""));
                return t
            },
            ...
            applySvgAttributes: function (e, t, i) {
                ...
                for (r = 0; r < e.attributes.length; r++) 
                    ...
                    /style/i.test(o.nodeName)
                        ? O
                            .Utils
                            .extractCSSText(o.value, c)
                        : l[o.nodeName] = o.value;
                for (
                    n in B.isUndefined(a.opacity) || (a["stroke-opacity"] = a.opacity, a["fill-opacity"] = a.opacity, delete a.opacity),
                    i && B.defaults(a, i),
                    B.extend(a, l, c),
                    a.visible = !(B.isUndefined(a.display) && /none/i.test(a.display)) || B.isUndefined(a.visibility) && /hidden/i.test(a.visibility),
                    a
                ) 
                    switch (s = a[n], n) {
                        case "transform":
                            if (/none/i.test(s)) 
                                break;
                            var d = e.transform && e.transform.baseVal && 0 < e.transform.baseVal.length
                                ? e
                                    .transform
                                    .baseVal[0]
                                    .matrix
            ...
            read: {
                ...
                path: function (e, t) {
                    ...
                    if (B.each(m, function (e, t) {
                        var i,
                            ...
                            p = g.toLowerCase();
                        switch (
                            k = (k = (k = e.slice(1).trim()).replace(/(-?\d+(?:\.\d*)?)[eE]([+\-]?\d+)/g, function (e, t, i) {
                            ...
                            case "z":
                                if (E <= t) 
                                    ...
                                    r = M.x,
                                    n = M.y,
                                    i = new O.Anchor(r, n, void 0, void 0, void 0, void 0, O.Commands.close);
                            ...
                            case "v":
                                var v = /h/i.test(p)
                                    ...
                                    y = /x/i.test(v)
                                        ...
                                        : "x";
                                (
                                    i = new O.Anchor(void 0, void 0, void 0, void 0, void 0, void 0, O.Commands.line)
                                )[v] = parseFloat(k[0]),
                                i[y] = M[y],
                                R && (i[v] += M[v]),
                                M = i;
                            ...
                            case "s":
                                ...
                                R && (a += s, l += o, c += s, h += o, d += s, u += o),
                                B.isObject(M.controls) || O
                                    .Anchor
                                    .AppendCurveProperties(M),
                                M
                                    .controls
                                    .right
                                    .set(a - M.x, l - M.y),
                                i = new O.Anchor(d, u, c - d, h - u, void 0, void 0, O.Commands.curve),
                                A = (M = i).controls.left;
                                break;
                            case "t":
                            case "q":
                                ...
                                u = /q/i.test(p)
                                    ...
                                    : (c = (f = I(M, A, R)).x, h = f.y, d = parseFloat(k[0]), parseFloat(k[1])),
                                R && (a += s, l += o, c += s, h += o, d += s, u += o),
                                B.isObject(M.controls) || O
                                    .Anchor
                                    .AppendCurveProperties(M),
                ...
                "rounded-rect": function (e, t) {
                    var i = parseFloat(e.getAttribute("x")) || 0,
                        ...
                        h = new O.Vector(n, s),
                        d = new O
                            .RoundedRectangle(i + l, r + c, o, a, h)
                            .noStroke();
                    return d.fill = "black",
                    O
                        .Utils
                ...
                lineargradient: function (e, t) {
                    for (
                        ...
                        if (B.isNull(f)) 
                            f = (h = !!p && p.match(/stop\-color\:\s?([\#a-fA-F0-9]*)/)) && 1 < h.length
                                ? h[1]
                                : void 0;
                        if (B.isNull(g)) 
                            g = (h = !!p && p.match(/stop\-opacity\:\s?([0-9\.\-]*)/)) && 1 < h.length
                                ? parseFloat(h[1])
                                : 1;
                ...
                radialgradient: function (e, t) {
                    ...
                    for (
                        ...
                        if (B.isNull(g)) 
                            g = (d = !!m && m.match(/stop\-color\:\s?([\#a-fA-F0-9]*)/)) && 1 < d.length
                                ? d[1]
                                : void 0;
                        if (B.isNull(p)) 
                            p = (d = !!m && m.match(/stop\-opacity\:\s?([0-9\.\-]*)/)) && 1 < d.length
                                ? parseFloat(d[1])
                                : 1;
            ...
            getCurveBoundingBox: function (e, t, i, r, n, s, o, a) {
                ...
                for (var _, x = m.length, b = x; x--;) 
                    _ = 1 - (d = m[x]),
                    v[0][x] = _ * _ * _ * e + 3 * _ * _ * d * i + 3 * _ * d * d * n + d * d * d * o,
                    v[1][x] = _ * _ * _ * t + 3 * _ * _ * d * r + 3 * _ * d * d * s + d * d * d * a;
                return v[0][b] = e,
                v[1][b] = t,
                v[0][b + 1] = o,
                v[1][b + 1] = a,
            ...
            getCurveFromPoints: function (e, t) {
                for (var i = e.length, r = i - 1, n = 0; n < i; n++) {
                    var s = e[n];
                    B.isObject(s.controls) || O
                        .Anchor
                        .AppendCurveProperties(s);
                    var o = t
                            ? y(n - 1, i)
                            : f(n - 1, 0),
                        a = t
            ...
            getControlPoints: function (e, t, i) {
                var r = O
                    ...
                    o = O
                        ...
                        .distanceBetween(i, t),
                    a = (r + n) / 2;
                return s < 1e-4 || o < 1e-4
                    ? B.isBoolean(t.relative) && !t.relative && (
            ...
            getReflection: function (e, t, i) {
                return new O.Vector(2 * e.x - (t.x + e.x) - (
                    i
                        ? e.x
                        : 0
                ), 2 * e.y - (t.y + e.y) - (
            ...
            Collection: function () {
                ...
                1 < arguments.length
                    ...
                    : arguments[0] && Array.isArray(arguments[0]) && Array
                        .prototype
                        .push
    ...
    B.extend(O.Utils.Collection.prototype, O.Utils.Events, {
        pop: function () {
            var e = Array
                ...
                .pop
                .apply(this, arguments);
            return this.trigger(O.Events.remove, [e]),
            e
        },
        shift: function () {
            var e = Array
        ...
        push: function () {
            var e = Array
                ...
                .push
                .apply(this, arguments);
            return this.trigger(O.Events.insert, arguments),
            e
        },
        unshift: function () {
            var e = Array
        ...
        splice: function () {
            var e,
                t = Array
                    ...
                    .splice
                    .apply(this, arguments);
            return this.trigger(O.Events.remove, t),
            2 < arguments.length && (
                e = this.slice(arguments[0], arguments[0] + arguments.length - 2),
    ...
    B.extend(O.prototype, O.Utils.Events, {
        constructor: O,
        appendTo: function (e) {
            return e.appendChild(this.renderer.domElement),
            this
        },
        play: function () {
            return O
        ...
        update: function () {
            ...
            var i = this.width,
                r = this.height,
                n = this.renderer;
            return i === n.width && r === n.height || n.setSize(i, r, this.ratio),
        ...
        add: function (e) {
            var t = e;
            return t instanceof Array || (t = B.toArray(arguments)),
            this
                .scene
                .add(t),
            this
        ...
        makeCurve: function (e) {
            ...
            return a
                .center()
                .translation
                .set(l.left + l.width / 2, l.top + l.height / 2),
            this
                .scene
                .add(a),
            a
            ...
            var r,
                ...
                t = B.bind(function (e) {
                    for (a.temp.innerHTML = e, n = 0; n < a.temp.children.length; n++) 
                        ...
                        o.add(this.interpret(r));
                    if (B.isFunction(i)) {
                        var t = a.temp.children.length <= 1
                            ? a
                                .temp
                                .children[0]
                            : a.temp.children;
...
function (i) {
    ...
    r.extend(n.prototype, i.Utils.Events, {
        ...
        add: function (e, t) {
            return arguments.length <= 0 || (
                arguments.length <= 1
                    ? r.isNumber(e)
                        ? (this.x += e, this.y += e)
                        : e && r.isNumber(e.x) && r.isNumber(e.y) && (this.x += e.x, this.y += e.y)
                    : (this.x += e, this.y += t)
            ),
            this
        },
        ...
        rotate: function (e) {
            var t = Math.cos(e),
                i = Math.sin(e);
            return this.x = this.x * t - this.y * i,
    ...
    var t = {
                ...
                return arguments.length <= 0
                    ...
                    : (
                        arguments.length <= 1
                            ? r.isNumber(e)
                                ? (this._x += e, this._y += e)
                                : e && r.isNumber(e.x) && r.isNumber(e.y) && (this._x += e.x, this._y += e.y)
                            : (this._x += e, this._y += t),
                        this.trigger(i.Events.change)
                    )
            },
            ...
            rotate: function (e) {
                var t = Math.cos(e),
                    i = Math.sin(e);
                return this._x = this._x * t - this._y * i,
        ...
        s = {
            ...
            set: function (e) {
                this._x = e,
                this.trigger(i.Events.change, "x")
            }
        },
        o = {
            enumerable: !0,
            ...
            set: function (e) {
                this._y = e,
                this.trigger(i.Events.change, "y")
            }
        };
...
function (d) {
    ...
    f.extend(d.Anchor, {
        ...
        MakeObservable: function (e) {
            Object.defineProperty(e, "command", {
                ...
                set: function (e) {
                    return this._command = e,
                    this._command !== u.curve || f.isObject(this.controls) || t.AppendCurveProperties(
                        this
                    ),
                    this.trigger(d.Events.change)
                }
    ...
    var i = {
        ...
        listen: function () {
            return f.isObject(this.controls) || d
                .Anchor
                .AppendCurveProperties(this),
            this
                .controls
                .left
                .bind(d.Events.change, this._broadcast),
            this
                .controls
                .right
                .bind(d.Events.change, this._broadcast),
        ...
        ignore: function () {
            return this
                .controls
                .left
                .unbind(d.Events.change, this._broadcast),
            this
                .controls
                .right
                .unbind(d.Events.change, this._broadcast),
        ...
        clone: function () {
            ...
            return t.relative = this._relative,
            t
        },
        toObject: function () {
            var e = {
            ...
            return this._command && (e.command = this._command),
    ...
    d
        .Anchor
        .MakeObservable(d.Anchor.prototype)
}((
    "undefined" != typeof global
        ? global
        : this || self || window
...
function (T) {
    ...
    a.extend(e, {
        ...
        Multiply: function (e, t, i) {
            ...
            var a = e[0],
                ...
                S = t[7],
                C = t[8];
            return (i = i || new T.Array(9))[0] = a * m + l * _ + c * w,
            i[1] = a * v + l * x + c * S,
            i[2] = a * y + l * b + c * C,
            i[3] = h * m + d * _ + u * w,
            i[4] = h * v + d * x + u * S,
    ...
    a.extend(e.prototype, T.Utils.Events, {
        ...
        set: function (e) {
            var t = e;
            return 1 < arguments.length && (t = a.toArray(arguments)),
            this.elements[0] = t[0],
            this.elements[1] = t[1],
            this.elements[2] = t[2],
            this.elements[3] = t[3],
        ...
        identity: function () {
            return this.elements[0] = e.Identity[0],
        ...
        multiply: function (e, t, i, r, n, s, o, a, l) {
            ...
            var d = this.elements,
                ...
                R = u[7],
                E = u[8];
            return this.elements[0] = f * w + g * A + p * P,
        ...
        toArray: function (e, t) {
            ...
            return r
                ? (t[0] = n, t[1] = a, t[2] = s, t[3] = l, t[4] = o, void(t[5] = c))
                : [
                    n,
                    a,
                    s,
    ...
    var R = P.Utils.mod,
        ...
        a = {
            ...
            createElement: function (e, t) {
                ...
                return "svg" === i && (t = s.defaults(t || {}, {version: a.version})),
                ...
                for (var i, r = e.length, n = r - 1, s = "", o = 0; o < r; o++) {
                    ...
                    switch (b.command) {
                        ...
                        case P.Commands.move:
                            i = b,
                            a = P.Commands.move + " " + k + " " + M;
                            break;
                        default:
                            a = b.command + " " + k + " " + M
                    }
                    n <= o && t && (b.command === P.Commands.curve && (
                        A = i,
            ...
            group: {
                appendChild: function (e) {
                    ...
                    if (t) {
                        var i = t.nodeName;
                        !i || /(radial|linear)gradient/i.test(i) || e._clip || this
                            .elem
                            .appendChild(t)
                    }
                },
                removeChild: function (e) {
                    var t = e._renderer.elem;
                    t && t.parentNode == this.elem && (
                        t.nodeName && (e._clip || this.elem.removeChild(t))
                    )
                },
                orderChild: function (e) {
                    this
                        .elem
                        .appendChild(e._renderer.elem)
                },
                ...
                render: function (e) {
                    if (this._update(), 0 === this._opacity && !this._flagOpacity) 
                        return this;
                    this._renderer.elem || (
                        this._renderer.elem = a.createElement("g", {id: this.id}),
                    ...
                    t && this
                        ._renderer
                        .elem
                        .setAttribute("transform", "matrix(" + this._matrix.toString() + ")");
                    ...
                    return this._flagOpacity && this
                        ._renderer
                        .elem
                        .setAttribute("opacity", this._opacity),
                    this._flagClassName && this
                        ._renderer
                        .elem
                        .setAttribute("class", this._className),
                    this._flagAdditions && this
                        .additions
                        .forEach(a.group.appendChild, i),
                    this._flagSubtractions && this
                        .subtractions
                        .forEach(a.group.removeChild, i),
                    this._flagOrder && this
                        .children
                        .forEach(a.group.orderChild, i),
                    this._flagMask && (
                        this._mask
            ...
            path: {
                render: function (e) {
                    ...
                    var t = {};
                    if (
                        (this._matrix.manual || this._flagMatrix) && (t.transform = "matrix(" + this._matrix.toString() + ")"),
                        this._flagVertices
                    ) {
                    ...
                    if (
                        this._fill && this._fill._renderer && (
                            this._fill._update(),
                            a[this._fill._renderer.type].render.call(this._fill, e, !0)
                        ),
                        this._flagFill && (
                            t.fill = this._fill && this._fill.id
                                ? "url(#" + this._fill.id + ")"
                                : this._fill
                        ),
                        this._stroke && this._stroke._renderer && (
                            this._stroke._update(),
                            a[this._stroke._renderer.type].render.call(this._stroke, e, !0)
                        ),
                        this._flagStroke && (
                            t.stroke = this._stroke && this._stroke.id
                                ? "url(#" + this._stroke.id + ")"
                                : this._stroke
                        ),
                        this._flagLinewidth && (t["stroke-width"] = this._linewidth),
                        this._flagOpacity && (t["stroke-opacity"] = this._opacity, t["fill-opacity"] = this._opacity),
                        ...
                        this.dashes && 0 < this.dashes.length && (t["stroke-dasharray"] = this.dashes.join(" ")),
                        this._renderer.elem
                        ...
                        this._clip
                            ? (n.removeAttribute("id"), r.setAttribute("id", this.id), r.appendChild(n))
                            : (
            ...
            text: {
                render: function (e) {
                    ...
                    if (
                        ...
                        this._flagAlignment && (t["text-anchor"] = a.alignments[this._alignment] || this._alignment),
                        this._flagBaseline && (t["alignment-baseline"] = t["dominant-baseline"] = this._baseline),
                        ...
                        this._clip
                            ? (r.removeAttribute("id"), i.setAttribute("id", this.id), i.appendChild(r))
                            : (
                    ...
                    return this._flagValue && (this._renderer.elem.textContent = this._value),
                    this.flagReset()
                }
            },
            "linear-gradient": {
            ...
            "radial-gradient": {
                render: function (e, t) {
                    ...
                    var i = {};
                    if (
                        this._flagCenter && (i.cx = this.center._x, i.cy = this.center._y),
                        this._flagFocal && (i.fx = this.focal._x, i.fy = this.focal._y),
            ...
            texture: {
                render: function (e, t) {
                    ...
                    if (
                        (this._flagOffset || this._flagLoaded || this._flagScale) && (i.x = this._offset.x, i.y = this._offset.y, n && (
                            i.x -= n.width / 2,
                            i.y -= n.height / 2,
                            this._scale instanceof P.Vector
                                ? (i.x *= this._scale.x, i.y *= this._scale.y)
                                : (i.x *= this._scale, i.y *= this._scale)
                        ), 0 < i.x && (i.x *= -1), 0 < i.y && (i.y *= -1)),
                        (this._flagScale || this._flagLoaded || this._flagRepeat) && (i.width = 0, i.height = 0, n)
                    ) {
                        switch (
                    ...
                    this._renderer.elem && this._renderer.image && !this._renderer.appended && (
    ...
    s.extend(e.prototype, P.Utils.Events, {
        ...
        render: function () {
            return a
                .group
                .render
                .call(this.scene, this.domElement),
            this
        }
    })
}((
...
function (W) {
    var z = W.Utils.mod,
        ...
        Z = {
            ...
            shim: function (e, t) {
                return e.tagName = e.nodeName = t || "canvas",
                e.nodeType = 1,
            ...
            path: {
                render: function (e, t, i) {
                    ...
                    o && (
                        X.isString(o)
                            ? e.fillStyle = o
                            : (Z[o._renderer.type].render.call(o, e), e.fillStyle = o._renderer.effect)
                    ),
                    n && (
                        X.isString(n)
                            ? e.strokeStyle = n
                            : (Z[n._renderer.type].render.call(n, e), e.strokeStyle = n._renderer.effect)
                    ),
                    s && (e.lineWidth = s),
                    d && (e.miterLimit = d),
                    h && (e.lineJoin = h),
                    ...
                    return u && e.closePath(),
                    B || i || (
                        Z.isHidden.test(o) || ((O = o._renderer && o._renderer.offset) && (
                            e.save(),
                            e.translate(-o._renderer.offset.x, -o._renderer.offset.y),
                            e.scale(o._renderer.scale.x, o._renderer.scale.y)
                        ), e.fill(), O && e.restore()),
                        Z.isHidden.test(n) || ((O = n._renderer && n._renderer.offset) && (
                            e.save(),
            ...
            text: {
                render: function (e, t, i) {
                    ...
                    return t || p && !_
                        ? (
                            m || (e.save(), e.transform(h[0], h[3], h[1], h[4], h[2], h[5])),
                            v || (e.font = [
                                this._style, this._weight, this._size + "px/" + this._leading + "px",
                                this._family
                            ].join(" ")),
                            e.textAlign = Z.alignments[this._alignment] || this._alignment,
                            e.textBaseline = this._baseline,
                            f && (
                                X.isString(f)
                                    ? e.fillStyle = f
                                    : (Z[f._renderer.type].render.call(f, e), e.fillStyle = f._renderer.effect)
                            ),
                            d && (
                                X.isString(d)
                                    ? e.strokeStyle = d
                                    : (Z[d._renderer.type].render.call(d, e), e.strokeStyle = d._renderer.effect)
                            ),
                            u && (e.lineWidth = u),
                            X.isNumber(g) && (e.globalAlpha = g),
                            y && 0 < y.length && e.setLineDash(y),
                            _ || i || (Z.isHidden.test(f) || (
                                f._renderer && f._renderer.offset
                                    ? (
                                        l = H(f._renderer.scale.x),
                                        c = H(f._renderer.scale.y),
                                        e.save(),
                                        e.translate(-H(f._renderer.offset.x), -H(f._renderer.offset.y)),
                                        e.scale(l, c),
                                        r = this._size / f._renderer.scale.y,
                                        n = this._leading / f._renderer.scale.y,
                                        e.font = [
                                            this._style, this._weight, H(r) + "px/",
                                            H(n) + "px",
                                            this._family
                                        ].join(" "),
                                ...
                                d._renderer && d._renderer.offset
                                    ? (
                                        ...
                                        e.save(),
                                        e.translate(-H(d._renderer.offset.x), -H(d._renderer.offset.y)),
                                        e.scale(l, c),
                    ...
                    if (
                        ...
                        for (var t = 0; t < this.stops.length; t++) {
                            ...
                            this
                                ._renderer
                                .effect
                                .addColorStop(i._offset, i._color)
                        }
                    }
                    return this.flagReset()
                }
            ...
            "radial-gradient": {
                render: function (e) {
                    if (
                        this._update(),
                        !this._renderer.effect || this._flagCenter || this._flagFocal || this._flagRadius || this._flagStops
                    ) {
            ...
            texture: {
                render: function (e) {
                    ...
                    var t = this.image;
                    return (
                        !this._renderer.effect || (this._flagLoaded || this._flagImage || this._flagVideo || this._flagRepeat) && this.loaded
                    ) && (this._renderer.effect = e.createPattern(this.image, this._repeat)),
                    (this._flagOffset || this._flagLoaded || this._flagScale) && (
                        this._renderer.offset instanceof W.Vector || (this._renderer.offset = new W.Vector),
                    ...
                    (this._flagScale || this._flagLoaded) && (
                        this._renderer.scale instanceof W.Vector || (this._renderer.scale = new W.Vector),
                        this._scale instanceof W.Vector
    ...
    X.extend(e.prototype, W.Utils.Events, {
        ...
        setSize: function (e, t, i) {
            ...
            this.domElement.style && X.extend(this.domElement.style, {
                width: e + "px",
                height: t + "px"
            }),
        ...
        render: function () {
            var e = 1 === this.ratio;
            return e || (this.ctx.save(), this.ctx.scale(this.ratio, this.ratio)),
            this.overdraw || this
                .ctx
...
function (W) {
        ...
        K = {
            ...
            group: {
                ...
                render: function (e, t) {
                    ...
                    if (
                        (r || n) && (
                            this._renderer.matrix || (this._renderer.matrix = new W.Array(9)),
                        ...
                        this._mask && (
                            ...
                            K[this._mask._renderer.type].render.call(this._mask, e, t, this),
                            e.colorMask(!0, !0, !0, !0),
                        ...
                        for (var s = 0; s < this.subtractions.length; s++) 
                            K
                                .group
                                .removeChild(this.subtractions[s], e);
            ...
            path: {
                updateCanvas: function (e) {
                    ...
                    w && (
                        Y.isString(w)
                            ? y.fillStyle = w
                            : (K[w._renderer.type].render.call(w, y, e), y.fillStyle = w._renderer.effect)
                    ),
                    x && (
                        Y.isString(x)
                            ? y.strokeStyle = x
                    ...
                    K
                        .isHidden
                        .test(w) || ((p = w._renderer && w._renderer.offset) && (
                            y.save(),
                    ...
                    K
                        .isHidden
                        .test(x) || ((p = x._renderer && x._renderer.offset) && (
                            y.save(),
                ...
                getBoundingClientRect: function (e, t, i) {
                    ...
                    e.forEach(function (e) {
                        ...
                        d = Math.max(a, d),
                        f = Math.max(l, f),
                        e.controls && (s = c.left, o = c.right, s && o && (
                            t = e._relative
                                ? s.x + a
                                : s.x,
                            i = e._relative
                ...
                render: function (e, t, i) {
                    ...
                    var r = this.parent,
                        ...
                        o = this._flagVertices || this._flagFill || this._fill instanceof W.LinearGradient && (
                            this._fill._flagSpread || this._fill._flagStops || this._fill._flagEndPoints
                        ) || this._fill instanceof W.RadialGradient && (
                            this._fill._flagSpread || this._fill._flagStops || this._fill._flagRadius || this._fill._flagCenter || this._fill._flagFocal
                        ) || this._fill instanceof W.Texture && (
                            this._fill._flagLoaded && this._fill.loaded || this._fill._flagImage || this._fill._flagVideo || this._fill._flagRepeat || this._fill._flagOffset || this._fill._flagScale
                            ...
                            this._stroke._flagSpread || this._stroke._flagStops || this._stroke._flagRadius || this._stroke._flagCenter || this._stroke._flagFocal
                        ) || this._stroke instanceof W.Texture && (
                            this._stroke._flagLoaded && this._stroke.loaded || this._stroke._flagImage || this._stroke._flagVideo || this._stroke._flagRepeat || this._stroke._flagOffset || this._fill._flagScale
                        ) || this._flagStroke || this._flagLinewidth || this._flagOpacity || r._flagOpacity || this._flagVisible || this._flagCap || this._flagJoin || this._flagMiter || this._flagScale || this.dashes && 0 < this.dashes.length || !this._renderer.texture;
                    return (n || s) && (
                        this._renderer.matrix || (this._renderer.matrix = new W.Array(9)),
                        this._matrix.toArray(!0, l),
                    ...
                    o
                        ? (
                            ...
                            this._renderer.triangles || (this._renderer.triangles = new W.Array(12)),
                            this._renderer.opacity = this._opacity * r._renderer.opacity,
                            K.path.getBoundingClientRect(this._renderer.vertices, this._linewidth, this._renderer.rect),
                    ...
                    !this._clip || i
                        ? (
                            e.bindBuffer(e.ARRAY_BUFFER, this._renderer.textureCoordsBuffer),
            ...
            text: {
                updateCanvas: function (e) {
                    ...
                    _ || (i.font = [
                        e._style, e._weight, e._size + "px/" + e._leading + "px",
                        e._family
                    ].join(" ")),
                    i.textAlign = "center",
                    ...
                    o && (
                        Y.isString(o)
                            ? i.fillStyle = o
                            : (K[o._renderer.type].render.call(o, i, e), i.fillStyle = o._renderer.effect)
                    ),
                    n && (
                        Y.isString(n)
                            ? i.strokeStyle = n
                        ...
                        .test(o) || (
                            o._renderer && o._renderer.offset
                                ? (
                                    ...
                                    i.save(),
                                    i.translate(-H(o._renderer.offset.x), -H(o._renderer.offset.y)),
                                    i.scale(g, p),
                                    c = e._size / o._renderer.scale.y,
                                    h = e._leading / o._renderer.scale.y,
                                    i.font = [
                                        e._style, e._weight, H(c) + "px/",
                                        H(h) + "px",
                                        e._family
                                    ].join(" "),
                        ...
                        .test(n) || (
                            n._renderer && n._renderer.offset
                                ? (
                                    ...
                                    i.save(),
                                    i.translate(-H(n._renderer.offset.x), -H(n._renderer.offset.y)),
                                    i.scale(g, p),
                ...
                getBoundingClientRect: function (e, t) {
                    ...
                    var r = 1.25 * i
                            .measureText(e._value)
                            .width,
                        n = 1.25 * Math.max(e._size, e._leading);
                    this._linewidth && !K
                        .isHidden
                        .test(this._stroke) && (r += 2 * this._linewidth, n += 2 * this._linewidth);
                    var s = r / 2,
                        o = n / 2;
                ...
                render: function (e, t, i) {
                    ...
                    var r = this.parent,
                        ...
                        o = this._flagVertices || this._flagFill || this._fill instanceof W.LinearGradient && (
                            ...
                            this._stroke._flagLoaded && this._stroke.loaded || this._stroke._flagImage || this._stroke._flagVideo || this._stroke._flagRepeat || this._stroke._flagOffset || this._fill._flagScale
                        ) || this._flagStroke || this._flagLinewidth || this._flagOpacity || r._flagOpacity || this._flagVisible || this._flagScale || this._flagValue || this._flagFamily || this._flagSize || this._flagLeading || this._flagAlignment || this._flagBaseline || this._flagStyle || this._flagWeight || this._flagDecoration || this.dashes && 0 < this.dashes.length || !this._renderer.texture;
                    return (n || s) && (
                        this._renderer.matrix || (this._renderer.matrix = new W.Array(9)),
                        this._matrix.toArray(!0, l),
                        a(l, r._renderer.matrix, this._renderer.matrix),
                        ...
                        if (
                            ...
                            for (var i = 0; i < this.stops.length; i++) {
                                ...
                                this
                                    ._renderer
                                    .effect
                                    .addColorStop(r._offset, r._color)
                            }
                        }
                        return this.flagReset()
                    }
                ...
                render: function (e, t) {
                    if (e.canvas.getContext("2d")) {
                        ...
                        if ((this._flagLoaded || this._flagImage || this._flagVideo || this._flagRepeat) && this.loaded) 
                            ...
                            return this.flagReset();
                        return (this._flagOffset || this._flagLoaded || this._flagScale) && (
                            this._renderer.offset instanceof W.Vector || (this._renderer.offset = new W.Vector),
                            this._renderer.offset.x = -this._offset.x,
                            this._renderer.offset.y = -this._offset.y,
                            i && (
            ...
            updateTexture: function (e, t) {
                ...
                this.canvas.width <= 0 || this.canvas.height <= 0 || e.texImage2D(
                    e.TEXTURE_2D,
                    0,
                    e.RGBA,
                    e.RGBA,
            ...
            updateBuffer: function (e, t, i) {
                ...
                Y.isObject(t._renderer.textureCoordsBuffer) && e.deleteBuffer(
            ...
            program: {
                create: function (t, e) {
                    ...
                    if (
                        ...
                        throw r = t.getProgramInfoLog(i),
                        t.deleteProgram(i),
                        new W
                            .Utils
                            .Error("unable to link program: " + r);
                    return i
                }
            },
            shaders: {
                create: function (e, t, i) {
                    ...
                    if (
                        ...
                        throw n = e.getShaderInfoLog(r),
                        e.deleteShader(r),
                        new W
                            .Utils
                            .Error("unable to compile shader " + r + ": " + n);
                    return r
                },
                types: {
    ...
    var t = W[W.Types.webgl] = function (e) {
        ...
        if (
            this.domElement = e.domElement || document.createElement("canvas"),
            Y.isUndefined(e.offscreenElement) || (K.canvas = e.offscreenElement, K.ctx = K.canvas.getContext("2d")),
            this.scene = new W.Group,
            ...
            i = this.ctx = this.domElement.getContext("webgl", t) || this.domElement.getContext("experimental-webgl", t),
            !this.ctx
        ) 
            throw new W
                .Utils
                .Error("unable to create a webgl context. Try using another renderer.");
        r = K
            .shaders
            .create(i, K.shaders.vertex, K.shaders.types.vertex),
        n = K
            .shaders
            .create(i, K.shaders.fragment, K.shaders.types.fragment),
        this.program = K
            .program
            .create(i, [r, n]),
        i.useProgram(this.program),
        this.program.position = i.getAttribLocation(this.program, "a_position"),
    ...
    Y.extend(t.prototype, W.Utils.Events, {
        ...
        setSize: function (e, t, i) {
            ...
            this.domElement.width = e * this.ratio,
            this.domElement.height = t * this.ratio,
            Y.isObject(this.domElement.style) && Y.extend(this.domElement.style, {
                width: e + "px",
                height: t + "px"
            }),
            e *= this.ratio,
            ...
            this
                ...
                .matrix[0] = this
                ._renderer
                .matrix[4] = this._renderer.scale = this.ratio,
            this._flagMatrix = !0,
            this
                .ctx
                .viewport(0, 0, e, t);
        ...
        render: function () {
            var e = this.ctx;
            return this.overdraw || e.clear(e.COLOR_BUFFER_BIT | e.DEPTH_BUFFER_BIT),
            K
                .group
                .render
                .call(this.scene, e, this.program),
            this._flagMatrix = !1,
            this
        }
    })
...
function (i) {
    ...
    e.extend(r, {
        ...
        MakeObservable: function (e) {
            var t = {
                ...
                set: function (e) {
                    this._translation && this
                        ._translation
                        .unbind(i.Events.change, this._renderer.flagMatrix),
                    this._translation = e,
                    this
                        ._translation
                        .bind(i.Events.change, this._renderer.flagMatrix),
                    r
                        .FlagMatrix
                        .call(this)
                }
            ...
            Object.defineProperty(e, "scale", {
                ...
                set: function (e) {
                    this._scale instanceof i.Vector && this
                        ._scale
                        .unbind(i.Events.change, this._renderer.flagMatrix),
                    this._scale = e,
                    this._scale instanceof i.Vector && this
    ...
    e.extend(r.prototype, i.Utils.Events, {
        ...
        _update: function (e) {
            ...
            e && this.parent && this.parent._update && this
                .parent
                ._update(),
            this
        },
...
function (I) {
    ...
    function b(e, t) {
        ...
        if (t <= 0) 
            return 0;
        if (i <= t) 
            return e._lengths.length - 1;
        for (var r = 0, n = 0; r < e._lengths.length; r++) {
            if (n + e._lengths[r] >= t) 
                return t -= n,
                Math.max(r - 1, 0) + t / e._lengths[r];
            n += e._lengths[r]
        }
        return -1
    }
    function o(e, t, i) {
        ...
        I
            .Utils
            .getCurveLength(r, a, n, l, s, c, o, h, i)
    }
    function l(e, t, i) {
        var r,
            n,
    ...
    U.extend(n, {
        ...
        MakeObservable: function (e) {
            ...
            Object.defineProperty(e, "fill", {
                ...
                set: function (e) {
                    (
                        this._fill instanceof I.Gradient || this._fill instanceof I.LinearGradient || this._fill instanceof I.RadialGradient || this._fill instanceof I.Texture
                    ) && this
                        ._fill
                        .unbind(I.Events.change, this._renderer.flagFill),
                    this._fill = e,
                    this._flagFill = !0,
                    (
                        this._fill instanceof I.Gradient || this._fill instanceof I.LinearGradient || this._fill instanceof I.RadialGradient || this._fill instanceof I.Texture
                        ...
                        ._fill
                        .bind(I.Events.change, this._renderer.flagFill)
                }
            }),
            Object.defineProperty(e, "stroke", {
                ...
                set: function (e) {
                    (
                        this._stroke instanceof I.Gradient || this._stroke instanceof I.LinearGradient || this._stroke instanceof I.RadialGradient || this._stroke instanceof I.Texture
                    ) && this
                        ._stroke
                        .unbind(I.Events.change, this._renderer.flagStroke),
                    this._stroke = e,
                    this._flagStroke = !0,
                    (
                        this._stroke instanceof I.Gradient || this._stroke instanceof I.LinearGradient || this._stroke instanceof I.RadialGradient || this._stroke instanceof I.Texture
                        ...
                        ._stroke
                        .bind(I.Events.change, this._renderer.flagStroke)
                }
            }),
    ...
    U.extend(n.prototype, I.Shape.prototype, {
        ...
        toObject: function () {
            ...
            t.translation = this
                ...
                .toObject(),
            t.rotation = this.rotation,
            t.scale = this.scale instanceof I.Vector
                ? this
                    .scale
                    .toObject()
                : this.scale,
        ...
        getBoundingClientRect: function (e) {
            ...
            for (n = 1; n < r; n++) 
                if (
                    ...
                    o = s.relative
                        ? t.multiply(s.controls.right.x + s.x, s.controls.right.y + s.y, 1)
                        : t.multiply(s.controls.right.x, s.controls.right.y, 1),
                    s = t.multiply(s.x, s.y, 1),
                    a = l.relative
                        ? t.multiply(l.controls.left.x + l.x, l.controls.left.y + l.y, 1)
                        : t.multiply(l.controls.left.x, l.controls.left.y, 1),
                    l = t.multiply(l.x, l.y, 1);
                    var f = I
                        .Utils
                        .getCurveBoundingBox(s.x, s.y, o.x, o.y, a.x, a.y, l.x, l.y);
                    d = g(f.min.y - i, d),
                    c = g(f.min.x - i, c),
                    h = p(f.max.x + i, h),
                    u = p(f.max.y + i, u)
        ...
        getPointAt: function (e, t) {
            for (
                ...
                if (C + this._lengths[w] >= v) {
                    this._closed
                        ? (i = I.Utils.mod(w, y), r = I.Utils.mod(w - 1, y), 0 === w && (i = r, r = w))
            ...
            s = I
                .Utils
                .getComponentOnCubicBezier(e, o, a, l, c),
            h = I
                .Utils
                .getComponentOnCubicBezier(e, d, u, f, g);
            var A = I
                    .Utils
                    .lerp(o, a, e),
                k = I
            ...
            return U.each(this.vertices, function (e, t) {
                if (t <= 0 && !o) 
                    ...
                    if (e.command === I.Commands.move) 
                        return a.push(new I.Anchor(s.x, s.y)),
                    ...
                    n <= t && (
                        this._closed && this._automatic
                            ? (i = l(s = e, s, r), a = a.concat(i), U.each(i, function (e, t) {
                                t <= 0 && s.command === I.Commands.move
                                    ? e.command = I.Commands.move
                                    : e.command = I.Commands.line
                            }))
        ...
        _updateLength: function (i, e) {
            ...
            var t = this.vertices.length,
                ...
                n = this.vertices[r],
                s = 0;
            return U.isUndefined(this._lengths) && (this._lengths = []),
            U.each(this.vertices, function (e, t) {
        ...
        _update: function () {
            if (this._flagVertices) {
                ...
                for (
                    ...
                    this._renderer.collection.length <= f && this
                        ._renderer
                        .collection
                        .push(new I.Anchor),
                    u < f && !t
                        ? (
                            ...
                            t = n,
                            (i = this._collection[f - 1]) && i.controls && (
                                n.controls.right.clear(),
                                this._renderer.collection[f - 1].controls.right.clear().lerp(i.controls.right, n.t)
                            )
                        )
                        : d <= f && f <= u && (
                            n = this._renderer.collection[f].copy(this._collection[f]),
                ...
                0 < d && !e && (
                    ...
                    e = n,
                    (r = this._collection[f + 1]) && r.controls && (
                        n.controls.left.clear(),
                        this._renderer.collection[f + 1].controls.left.copy(r.controls.left).lerp(I.Vector.zero, n.t)
                    )
                )
            }
            return I
        ...
        flagReset: function () {
            return this._flagVertices = this._flagFill = this._flagStroke = this._flagLinewidth = this._flagOpacity = this._flagVisible = this._flagCap = this._flagJoin = this._flagMiter = this._flagClassName = this._flagClip = !1,
            I
                .Shape
                .prototype
                .flagReset
...
function (n) {
        ...
        MakeObservable: function (e) {
            ...
            Object.defineProperty(e, "origin", {
                ...
                set: function (e) {
                    this._origin && this
                        ._origin
                        .unbind(n.Events.change, this._renderer.flagVertices),
                    this._origin = e,
                    this
                        ._origin
                        .bind(n.Events.change, this._renderer.flagVertices),
                    this
                        ._renderer
                        .flagVertices()
                }
    ...
    i.extend(r.prototype, s.prototype, {
        ...
        _update: function () {
            if (this._flagWidth || this._flagHeight) {
                ...
                this
                    ...
                    .command = n.Commands.line,
                this.vertices[4] && (
                    this.vertices[4].set(-e, -t).add(this._origin).command = n.Commands.line
                )
            }
            return s
                .prototype
        ...
        flagReset: function () {
            return this._flagWidth = this._flagHeight = !1,
            s
                .prototype
                .flagReset
                .call(this),
        ...
        clone: function (e) {
            ...
            t.rotation = this.rotation,
            t.scale = this.scale,
            i.each(n.Path.Properties, function (e) {
                t[e] = this[e]
            }, this),
            e && e.add(t),
            t
...
function (d) {
    ...
    a.extend(s.prototype, u.prototype, {
        ...
        clone: function (e) {
            ...
            n.scale = this.scale,
            a.each(d.Path.Properties, function (e) {
                n[e] = this[e]
            }, this),
            e && e.add(n),
            n
...
function (f) {
    ...
    o.extend(i.prototype, g.prototype, {
        ...
        clone: function (e) {
            ...
            t.rotation = this.rotation,
            t.scale = this.scale,
            o.each(f.Path.Properties, function (e) {
                t[e] = this[e]
            }, this),
            e && e.add(t),
            t
...
function (a) {
    ...
    i.extend(r.prototype, l.prototype, {
        ...
        flagReset: function () {
            return this._flagWidth = this._flagHeight = this._flagSides = !1,
            l
                .prototype
                .flagReset
                .call(this),
        ...
        clone: function (e) {
            ...
            t.rotation = this.rotation,
            t.scale = this.scale,
            i.each(a.Path.Properties, function (e) {
                t[e] = this[e]
            }, this),
            e && e.add(t),
            t
...
function (_) {
    ...
    c.extend(a.prototype, x.prototype, {
        ...
        _update: function () {
            if (this._flagStartAngle || this._flagEndAngle || this._flagInnerRadius || this._flagOuterRadius) {
                ...
                if (o) {
                    for (
                        s
                            ? (a[c].command = _.Commands.close, c++)
                            : d = --l - 1,
                        h = 0; h < l; h++
                    ) 
                        u = h / d,
        ...
        clone: function (e) {
            ...
            o.scale = this.scale,
            c.each(_.Path.Properties, function (e) {
                o[e] = this[e]
            }, this),
            e && e.add(o),
            o
...
function (l) {
    ...
    s.extend(o.prototype, c.prototype, {
        ...
        flagReset: function () {
            return this._flagInnerRadius = this._flagOuterRadius = this._flagSides = !1,
            c
                .prototype
                .flagReset
                .call(this),
        ...
        clone: function (e) {
            ...
            n.rotation = this.rotation,
            n.scale = this.scale,
            s.each(l.Path.Properties, function (e) {
                n[e] = this[e]
            }, this),
            e && e.add(n),
            n
...
function (a) {
    ...
    o.extend(c, {
        ...
        MakeObservable: function (e) {
            ...
            Object.defineProperty(e, "radius", {
                ...
                set: function (e) {
                    this._radius instanceof a.Vector && this
                        ._radius
                        .unbind(a.Events.change, this._renderer.flagRadius),
                    this._radius = e,
                    this._radius instanceof a.Vector && this
                        ._radius
                        .bind(a.Events.change, this._renderer.flagRadius),
                    this._flagRadius = !0
                }
            })
        }
    ...
    o.extend(c.prototype, l.prototype, {
        ...
        _update: function () {
            if (this._flagWidth || this._flagHeight || this._flagRadius) {
                var e,
                    ...
                    r = this._width,
                    n = this._height;
                t = this._radius instanceof a.Vector
        ...
        flagReset: function () {
            return this._flagWidth = this._flagHeight = this._flagRadius = !1,
            l
                .prototype
                .flagReset
                .call(this),
        ...
        clone: function (e) {
            ...
            n.rotation = this.rotation,
            n.scale = this.scale,
            o.each(a.Path.Properties, function (e) {
                n[e] = this[e]
            }, this),
            e && e.add(n),
            n
...
function (n) {
    ...
    s.extend(n.Text, {
        ...
        MakeObservable: function (e) {
            ...
            Object.defineProperty(e, "fill", {
                ...
                set: function (e) {
                    (
                        this._fill instanceof n.Gradient || this._fill instanceof n.LinearGradient || this._fill instanceof n.RadialGradient || this._fill instanceof n.Texture
                    ) && this
                        ._fill
                        .unbind(n.Events.change, this._renderer.flagFill),
                    this._fill = e,
                    this._flagFill = !0,
                    (
                        this._fill instanceof n.Gradient || this._fill instanceof n.LinearGradient || this._fill instanceof n.RadialGradient || this._fill instanceof n.Texture
                        ...
                        ._fill
                        .bind(n.Events.change, this._renderer.flagFill)
                }
            }),
            Object.defineProperty(e, "stroke", {
                enumerable: !0,
                ...
                set: function (e) {
                    (
                        this._stroke instanceof n.Gradient || this._stroke instanceof n.LinearGradient || this._stroke instanceof n.RadialGradient || this._stroke instanceof n.Texture
                    ) && this
                        ._stroke
                        .unbind(n.Events.change, this._renderer.flagStroke),
                    this._stroke = e,
                    this._flagStroke = !0,
                    (
                        this._stroke instanceof n.Gradient || this._stroke instanceof n.LinearGradient || this._stroke instanceof n.RadialGradient || this._stroke instanceof n.Texture
                        ...
                        ._stroke
                        .bind(n.Events.change, this._renderer.flagStroke)
                }
            }),
            Object.defineProperty(e, "clip", {
                enumerable: !0,
    ...
    s.extend(n.Text.prototype, n.Shape.prototype, {
        ...
        flagReset: function () {
            return this._flagValue = this._flagFamily = this._flagSize = this._flagLeading = this._flagAlignment = this._flagFill = this._flagStroke = this._flagLinewidth = this._flagOpacity = this._flagVisible = this._flagClip = this._flagDecoration = this._flagClassName = this._flagBaseline = !1,
            n
                .Shape
                .prototype
                .flagReset
    ...
    n
        .Text
        .MakeObservable(n.Text.prototype)
}((
    "undefined" != typeof global
        ? global
        : this || self || window
...
function (r) {
    ...
    n.extend(s.prototype, r.Utils.Events, {
        ...
        flagReset: function () {
            return this._flagOffset = this._flagColor = this._flagOpacity = !1,
            this
        }
    }),
    s.MakeObservable(s.prototype),
    ...
    n.extend(o.prototype, r.Utils.Events, {
        ...
        _update: function () {
            return (this._flagSpread || this._flagStops) && this.trigger(r.Events.change),
            this
        },
        flagReset: function () {
            return this._flagSpread = this._flagStops = !1,
            this
        }
    }),
    o.MakeObservable(o.prototype)
...
function (o) {
    ...
    a.extend(l.prototype, o.Gradient.prototype, {
        ...
        _update: function () {
            return (this._flagEndPoints || this._flagSpread || this._flagStops) && this.trigger(
                o.Events.change
            ),
            this
        },
        flagReset: function () {
            return this._flagEndPoints = !1,
            o
                .Gradient
                .prototype
                .flagReset
...
function (o) {
    var a = o.Utils,
        r = o.RadialGradient = function (e, t, i, r, n, s) {
            ...
            this.center = (new o.Vector).bind(o.Events.change, a.bind(function () {
                this._flagCenter = !0
            }, this)),
            this.radius = a.isNumber(i)
                ? i
                : 20,
            this.focal = (new o.Vector).bind(o.Events.change, a.bind(function () {
                this._flagFocal = !0
            }, this)),
    ...
    a.extend(r.prototype, o.Gradient.prototype, {
        ...
        flagReset: function () {
            return this._flagRadius = this._flagCenter = this._flagFocal = !1,
            o
                .Gradient
                .prototype
                .flagReset
...
function (s) {
    ...
    o.extend(a, {
        ...
        loadHeadlessBuffer: new Function(
            "texture",
            "loaded",
            ['var fs = require("fs");', "var buffer = fs.readFileSync(texture.src);", "texture.image.src = buffer;", "loaded();"].join("\n")
        ),
        getImage: function (e) {
            var t,
            ...
            return a
                ...
                .contains(i)
                    ...
                    : (
                        s.Utils.Image
                            ? (t = new s.Utils.Image, s.CanvasRenderer.Utils.shim(t, "img"))
                            : r.document
                                ? t = n.video.test(i)
        ...
        Register: {
            ...
            img: function (t, i) {
                var r = function (e) {
                    ...
                    n = function (e) {
                        throw o.isFunction(t.image.removeEventListener) && (
                            t.image.removeEventListener("load", r, !1),
                            t.image.removeEventListener("error", n, !1)
                        ),
                        new s
                            .Utils
                            .Error("unable to load " + t.src)
                    };
                o.isNumber(t.image.width) && 0 < t.image.width && o.isNumber(t.image.height) && 0 < t.image.height
                    ? r()
            ...
            video: function (t, i) {
                var r = function (e) {
                        t
                            .image
                            .removeEventListener("canplaythrough", r, !1),
                        t
                            .image
                ...
                if (
                    ...
                    if (s.Utils.isHeadless) 
                        throw new s
                            .Utils
                            .Error("video textures are not implemented in headless environments.");
                    t
                        .image
                        .setAttribute("two-src", t.src),
                    a
                        .ImageRegistry
                        .add(t.src, t.image),
                    t.image.src = t.src,
        ...
        load: function (e, t) {
            ...
            e._flagImage && (
                /canvas/i.test(r)
                    ...
                    : (e._src = i.getAttribute("two-src") || i.src, a.Register[r](e, t))
            ),
            e._flagSrc && (
        ...
        MakeObservable: function (e) {
            ...
            Object.defineProperty(e, "offset", {
                ...
                set: function (e) {
                    this._offset && this
                        ._offset
                        .unbind(s.Events.change, this._renderer.flagOffset),
                    this._offset = e,
                    this
                        ._offset
                        .bind(s.Events.change, this._renderer.flagOffset),
                    this._flagOffset = !0
                }
            }),
            Object.defineProperty(e, "scale", {
                ...
                set: function (e) {
                    this._scale instanceof s.Vector && this
                        ._scale
                        .unbind(s.Events.change, this._renderer.flagScale),
                    this._scale = e,
                    this._scale instanceof s.Vector && this
                        ._scale
                        .bind(s.Events.change, this._renderer.flagScale),
                    this._flagScale = !0
                }
            })
        }
    ...
    o.extend(a.prototype, s.Utils.Events, s.Shape.prototype, {
        ...
        _update: function () {
            return (this._flagSrc || this._flagImage) && (
                this.trigger(s.Events.change),
                (this._flagSrc || this._flagImage) && (this.loaded = !1, a.load(this, o.bind(function () {
                    this.loaded = !0,
                    this
                        .trigger(s.Events.change)
        ...
        flagReset: function () {
            return this._flagSrc = this._flagImage = this._flagLoaded = this._flagVideo = this._flagScale = this._flagOffset = !1,
            this
        }
    }),
    a.MakeObservable(a.prototype)
...
function (o) {
    ...
    g.extend(i.prototype, p.prototype, {
        ...
        _update: function () {
            ...
            if (
                ...
                this._playing && 0 < this._frameRate && (
                    ...
                    n = 1e3 * ((l = this._lastFrame + 1) - this._firstFrame) / this._frameRate,
                    this._loop
                        ? i %= n
                        : i = Math.min(i, n),
                    s = g.lerp(this._firstFrame, l, i / n),
                    (s = Math.floor(s)) !== this._index && (this._index = s) >= this._lastFrame - 1 && this._onLastFrame && this._onLastFrame()
                );
        ...
        flagReset: function () {
            return this._flagTexture = this._flagColumns = this._flagRows = this._flagFrameRate = !1,
            p
                .prototype
                .flagReset
                .call(this),
    ...
    h.extend(s.prototype, d.prototype, {
        ...
        _update: function () {
            var e,
                ...
                a,
                l = this._textures;
            return this._flagTextures && (this._amount = l.length),
            this._flagFrameRate && (this._duration = 1e3 * this._amount / this._frameRate),
            this._playing && 0 < this._frameRate
                ? (
                    r = this._amount,
                    ...
                    n = 1e3 * ((a = this._lastFrame + 1) - this._firstFrame) / this._frameRate,
                    this._loop
                        ? i %= n
                        : i = Math.min(i, n),
                    ...
                    (o = Math.floor(o)) !== this._index && (
                        ...
                        (s = l[this._index]).loaded && (
                            ...
                            this.height !== t && (this.height = t),
                            this.fill = s,
                            o >= this._lastFrame - 1 && this._onLastFrame && this._onLastFrame()
                        )
                    )
                )
        ...
        flagReset: function () {
            return this._flagTextures = this._flagFrameRate = !1,
            d
                .prototype
                .flagReset
                .call(this),
    ...
    function i(e, t) {
        ...
        return r === t
            ...
            : (
                ...
                t
                    ? (e.parent = t, this.additions.push(e), void(this._flagAdditions = !0))
                    : (
        ...
        toObject: function () {
            var i = {
                ...
                translation: this
                    ...
                    .toObject(),
                rotation: this.rotation,
                scale: this.scale instanceof c.Vector
                    ? this
                        .scale
                        .toObject()
                    : this.scale,
        ...
        remove: function (e) {
            ...
            for (var r = 0; r < e.length; r++) 
                e[r] && this
                    ...
                    .ids[e[r].id] && this
                    .children
                    .splice(u.indexOf(this.children, e[r]), 1);
            return this
        },
        getBoundingClientRect: function (e) {
            var t;
            ...
            for (
                ...
                l.visible && !o.test(l._renderer.type) && (
                    t = l.getBoundingClientRect(e),
                    u.isNumber(t.top) && u.isNumber(t.left) && u.isNumber(t.right) && u.isNumber(t.bottom) && (n = h(t.top, n), i = h(t.left, i), r = d(t.right, r), s = d(t.bottom, s))
                )
            }
            return {
                top: n,
    ...
    return function s(o, a, l) {
            ...
            function (e, t, i) {
                ...
                !function () {
                    ...
                    c.nextCategory = function () {
                        return c._nextCategory = c._nextCategory << 1,
                        c._nextCategory
                    };
                    var r = function (e, t) {
                        t = t || {},
                        ...
                        var i = e.isStatic
                            ? "#2e2b44"
                            : s.choose(["#006BA6", "#0496FF", "#FFBC42", "#D81159", "#8F2D56"]);
                        e.render.fillStyle = e.render.fillStyle || i,
                        e.render.strokeStyle = e.render.strokeStyle || "#000",
                        e.render.sprite.xOffset += -(e.bounds.min.x - e.position.x) / (
                            e.bounds.max.x - e.bounds.min.x
                        ),
                        e.render.sprite.yOffset += -(e.bounds.min.y - e.position.y) / (
                    ...
                    c.setVertices = function (e, t) {
                        ...
                        c.setInertia(e, c._inertiaScale * h.inertia(e.vertices, e.mass)),
                    ...
                    c.setAngle = function (e, t) {
                        ...
                        for (var r = 0; r < e.parts.length; r++) {
                            ...
                            f.rotate(n.axes, i),
                            u.update(n.bounds, n.vertices, e.velocity),
                            0 < r && d.rotateAbout(n.position, i, e.position, n.position)
                        }
                    },
                    ...
                    c.scale = function (e, t, i, r) {
                        ...
                        for (var o = 0; o < e.parts.length; o++) {
                            ...
                            c.setInertia(a, c._inertiaScale * h.inertia(a.vertices, a.mass)),
                            h.translate(a.vertices, {
                                x: a.position.x,
                                y: a.position.y
                            }),
                        ...
                        1 < e.parts.length && (
                            e.area = n,
                            e.isStatic || (c.setMass(e, e.density * n), c.setInertia(e, s))
                        ),
                        e.circleRadius && (
                            t === i
                                ? e.circleRadius *= t
                    ...
                    c.update = function (e, t, i, r) {
                        ...
                        e.angularVelocity = (e.angle - e.anglePrev) * s * r + e.torque / e.inertia * n,
                        e.anglePrev = e.angle,
                        ...
                        for (var l = 0; l < e.parts.length; l++) {
                            ...
                            0 < l && (c.position.x += e.velocity.x, c.position.y += e.velocity.y),
                            0 !== e.angularVelocity && (
                                h.rotate(c.vertices, e.angularVelocity, e.position),
                                f.rotate(c.axes, e.angularVelocity),
                                0 < l && d.rotateAbout(c.position, e.angularVelocity, e.position, c.position)
                            ),
                    ...
                    c._totalProperties = function (e) {
                        ...
                        return t.centre = d.div(t.centre, t.mass),
                        t
                    }
                }()
            }, {
        ...
        2: [
            function (e, t, i) {
                ...
                d.add = function (e, t) {
                    ...
                    for (var r = 0; r < i.length; r++) {
                        ...
                        switch (n.type) {
                            case "body":
                                if (n.parent !== n) {
                                    s.warn(
                                        "Composite.add: skipped adding a compound body part (you must add its parent in" +
                                        "stead)"
                                    );
                                    break
                                }
                    ...
                    return o.trigger(e, "afterAdd", {object: t}),
                    e
                },
                d.remove = function (e, t, i) {
                    ...
                    return o.trigger(e, "afterRemove", {object: t}),
                    e
                },
                ...
                d.allBodies = function (e) {
                    for (var t = [].concat(e.bodies), i = 0; i < e.composites.length; i++) 
                        t = t.concat(d.allBodies(e.composites[i]));
                    return t
                },
                d.allConstraints = function (e) {
                    for (var t = [].concat(e.constraints), i = 0; i < e.composites.length; i++) 
                        t = t.concat(d.allConstraints(e.composites[i]));
                    return t
                },
                d.allComposites = function (e) {
                    for (var t = [].concat(e.composites), i = 0; i < e.composites.length; i++) 
                ...
                d.rebase = function (e) {
                    for (
                        var t = d.allBodies(e).concat(d.allConstraints(e)).concat(d.allComposites(e)),
                        i = 0;
                        i < t.length;
                        i++
                    ) 
                        t[i].id = s.nextId();
                    return d.setModified(e, !0, !0, !1),
                    e
                },
        ...
        4: [
            function (e, t, i) {
                ...
                (t.exports = r).create = function (e) {
                    return {id: r.id(e), vertex: e, normalImpulse: 0, tangentImpulse: 0}
                },
                r.id = function (e) {
                ...
                g.collisions = function (e, t) {
                    for (var i = [], r = t.pairs.table, n = 0; n < e.length; n++) {
                        ...
                        if ((!s.isStatic && !s.isSleeping || !o.isStatic && !o.isSleeping) && g.canCollide(s.collisionFilter, o.collisionFilter) && v.overlaps(s.bounds, o.bounds)) 
                            for (
                                var a = 1 < s.parts.length
                                    ? 1
                                    : 0; a < s.parts.length; a++
                            ) 
                                for (
                                    var l = s.parts[a],
                                    c = 1 < o.parts.length
                                        ? 1
                                        : 0; c < o.parts.length; c++
                                ) {
                                    var h = o.parts[c];
            ...
            function (e, t, i) {
                ...
                u.update = function (e, t, i) {
                    ...
                    if (
                        ...
                        e.frictionStatic = Math.max(o.frictionStatic, a.frictionStatic),
                        ...
                        for (var l = 0; l < n.length; l++) {
                            ...
                            d
                                ? s.push(d)
                                : s.push(r[h] = f.create(c))
                        }
                        e.separation = t.depth,
                        u.setActive(e, !0, i)
                    } else 
                        !0 === e.isActive && u.setActive(e, !1, i)
                },
            ...
            function (e, t, i) {
                ...
                c.update = function (e, t, i) {
                    var r,
                        ...
                        d = e.collisionActive,
                        u = [];
                    for (c.length = 0, h.length = 0, o = d.length = 0; o < t.length; o++) 
                        (r = t[o]).collided && (
                            ...
                            (s = l[n])
                                ...
                                : (s = f.create(r, i), l[n] = s, c.push(s), a.push(s))
                        );
                    for (o = 0; o < a.length; o++) 
                        (s = a[o]).isActive && -1 === g.indexOf(u, s.id) && (
                            f.setActive(s, !1, i),
                            h.push(s)
                        )
                },
                c.removeOld = function (e, t) {
                    ...
                    for (s = 0; s < o.length; s++) 
                        (r = (i = o[s]).collision).bodyA.isSleeping || r.bodyB.isSleeping
                            ? i.timeUpdated = t
                            : t - i.timeUpdated > c._pairMaxIdleLife && l.push(s);
                    for (s = 0; s < l.length; s++) 
                        delete a[(i = o[n = l[s] - s]).id],
                        o.splice(n, 1)
                },
                c.clear = function (e) {
                    return e.table = {},
                ...
                u.collides = function (e, t) {
                    for (var i = [], r = 0; r < t.length; r++) {
                        ...
                        if (c.overlaps(n.bounds, e.bounds)) 
                            for (
                                var s = 1 === n.parts.length
                                    ? 0
                                    : 1; s < n.parts.length; s++
                            ) {
                                var o = n.parts[s];
            ...
            function (e, t, i) {
                ...
                N.solvePosition = function (e, t) {
                    ...
                    for (i = 0; i < e.length; i++) 
                        (r = e[i]).isActive && !r.isSensor && (
                            s = (n = r.collision).parentA,
                            o = n.parentB,
                            a = n.normal,
                            l = j.sub(
                                j.add(o.positionImpulse, o.position, d),
                                j.add(s.positionImpulse, j.sub(o.position, n.penetration, u), f),
                                g
                            ),
                        ...
                        if (h.isActive && !h.isSensor) {
                            ...
                            for (var y = 0; y < m.length; y++) {
                                ...
                                P > h.friction * h.frictionStatic * T * i && (
                                    F = P,
                                    B = G.clamp(h.friction * R * i, -F, F)
                                );
                                var O = j.cross(b, g),
                                    I = j.cross(w, g),
                                    U = v / (
                                        u.inverseMass + f.inverseMass + u.inverseInertia * O * O + f.inverseInertia * I * I
                                    );
                                if (E *= U, B *= U, k < 0 && k * k > N._restingThresh * i) 
                                    _.normalImpulse = 0;
                                else {
                                ...
                                if (M * M > N._restingThreshTangent * i) 
                                    ...
                                    _.tangentImpulse = G.clamp(_.tangentImpulse + B, -F, F),
            ...
            function (e, t, i) {
                ...
                v.collides = function (e, t, i) {
                    ...
                    if (i && a) {
                        ...
                        if ((r = v._overlapAxes(e.vertices, t.vertices, e.axes)).overlap <= 0) 
                            return o.collided = !1,
                            o;
                        if ((n = v._overlapAxes(t.vertices, e.vertices, t.axes)).overlap <= 0) 
                            return o.collided = !1,
                            o;
                        r.overlap < n.overlap
                            ? (s = r, o.axisBody = e)
        ...
        12: [
            function (e, t, i) {
                ...
                b.create = function (e) {
                    ...
                    var i = t.bodyA
                            ? w.add(t.bodyA.position, t.pointA)
                            : t.pointA,
                        r = t.bodyB
                            ? w.add(t.bodyB.position, t.pointB)
                            : t.pointB,
                        n = w.magnitude(w.sub(i, r));
                    t.length = void 0 !== t.length
                        ? t.length
                        : n,
                    t.id = t.id || h.nextId(),
                    t.label = t.label || "Constraint",
                    t.type = "constraint",
                    t.stiffness = t.stiffness || (
                        0 < t.length
                            ? 1
                            : .7
                    ),
                    ...
                    return 0 === t.length && .1 < t.stiffness
                        ? (s.type = "pin", s.anchors = !1)
                        : t.stiffness < .9 && (s.type = "spring"),
                ...
                b.solve = function (e, t) {
                    var i = e.bodyA,
                        ...
                        s = e.pointB;
                    if (i || r) {
                        i && !i.isStatic && (w.rotate(n, i.angle - e.angleA, n), e.angleA = i.angle),
                        r && !r.isStatic && (w.rotate(s, r.angle - e.angleB, s), e.angleB = r.angle);
                        var o = n,
                            a = s;
                        if (i && (o = w.add(i.position, n)), r && (a = w.add(r.position, s)), o && a) {
                            ...
                            i && !i.isStatic && (
                                ...
                                h = w.cross(n, v) / _ * b._torqueDampen * i.inverseInertia * (1 - e.angularStiffness),
                            ...
                            r && !r.isStatic && (
                                ...
                                h = w.cross(s, v) / _ * b._torqueDampen * r.inverseInertia * (1 - e.angularStiffness),
                        ...
                        if (!(i.isStatic || 0 === r.x && 0 === r.y && 0 === r.angle)) {
                            ...
                            for (var n = 0; n < i.parts.length; n++) {
                                ...
                                0 !== r.angle && (
                                    ...
                                    0 < n && w.rotateAbout(s.position, r.angle, i.position, s.position)
                                ),
        ...
        13: [
            function (e, t, i) {
                    ...
                    i || (
                        t && t.render && t.render.canvas
                            ...
                            : e && e.element
                                ...
                                : (i = o.create(), f.warn(
                                    "MouseConstraint.create: options.mouse was undefined, options.element was undef" +
                                    "ined, may not function as expected"
                                ))
                    );
                    var r = {
                    ...
                    if (0 === i.button) {
                        if (r.bodyB) 
                            ...
                            for (var s = 0; s < t.length; s++) 
                                if (
                                    n = t[s],
                                    g.contains(n.bounds, i.position) && d.canCollide(n.collisionFilter, e.collisionFilter)
                                ) 
                                    for (
                                        var o = 1 < n.parts.length
                                            ? 1
                                            : 0; o < n.parts.length; o++
                                    ) {
                                        var a = n.parts[o];
                ...
                s._triggerEvents = function (e) {
                    var t = e.mouse,
                        i = t.sourceEvents;
                    i.mousemove && h.trigger(e, "mousemove", {mouse: t}),
                    i.mousedown && h.trigger(e, "mousedown", {mouse: t}),
                    i.mouseup && h.trigger(e, "mouseup", {mouse: t}),
            ...
            function (n, e, t) {
                (function (r) {
                    ...
                    function () {
                        ...
                        var i = function () {
                            return l._seed = (9301 * l._seed + 49297) % 233280,
                            l._seed / 233280
                        };
                        ...
                        l.logLevel = 1,
                        l.log = function () {
                            console && 0 < l.logLevel && l.logLevel <= 3 && console
                                .log
                                .apply(console, ["matter-js:"].concat(Array.prototype.slice.call(arguments)))
                        },
                        l.info = function () {
                            console && 0 < l.logLevel && l.logLevel <= 2 && console
                                .info
                                .apply(console, ["matter-js:"].concat(Array.prototype.slice.call(arguments)))
                        },
                        l.warn = function () {
        ...
        15: [
            function (e, t, i) {
                ...
                g.create = function (e, t) {
                    ...
                    return r.render && r.render.controller && (
                ...
                g.update = function (e, t, i) {
                    ...
                    for (
                        ...
                        0 < u.collisionStart.length && y.trigger(e, "collisionStart", {pairs: u.collisionStart}),
                    ...
                    return 0 < u.collisionActive.length && y.trigger(
                        e,
                        "collisionActive",
                        {pairs: u.collisionActive}
                    ),
                    0 < u.collisionEnd.length && y.trigger(
                        e,
                        "collisionEnd",
        ...
        16: [
            function (e, t, i) {
                ...
                r.off = function (e, t, i) {
                    if (t) {
                        "function" == typeof t && (i = t, t = c.keys(e.events).join(" "));
        ...
        19: [
            function (e, t, i) {
                ...
                r.create = function (e) {
                    ...
                    i.pixelRatio = i
                        .element
                        .getAttribute("data-pixel-ratio") || 1,
                    i.sourceEvents = {
                        mousemove: null,
                        mousedown: null,
                        mouseup: null,
                    ...
                    i.mousewheel = function (e) {
                        i.wheelDelta = Math.max(-1, Math.min(1, e.wheelDelta || -e.detail)),
                        e.preventDefault()
                    },
        ...
        20: [
            function (e, t, i) {
                ...
                a.register = function (e) {
                    if (
                        a.isPlugin(e) || l.warn("Plugin.register:", a.toString(e), "does not implement all required fields."),
                        e.name in a._registry
                    ) {
                        var t = a._registry[e.name],
                            i = a
                                .versionParse(e.version)
                                .number,
                            r = a
                                .versionParse(t.version)
                                .number;
                        r < i
                            ? (
                                l.warn("Plugin.register:", a.toString(t), "was upgraded to", a.toString(e)),
                                ...
                                o
                                    ? a.isUsed(e, o.name) || (
                                        ...
                                        o.install
                                            ? o.install(e)
                                            : (
                                                l.warn("Plugin.use:", a.toString(o), "does not specify an install function."),
                                                o._warned = !0
                                            ),
                                        o._warned
                                            ? (n.push("🔶 " + a.toString(o)), delete o._warned)
                                            : n.push("✅ " + a.toString(o)),
                                        e.used.push(o.name)
                                    )
                                    : n.push("❌ " + r[s])
                    ...
                    if (!(t in (e = e || {}))) {
                        ...
                        e[t] = l.map(r.uses || [], function (e) {
                            ...
                            var t = a.dependencyParse(e),
                                i = a.resolve(e);
                            return i && !a.versionSatisfies(i.version, t.range)
                                ? (l.warn(
                                    "Plugin.dependencies:",
                                    a.toString(i),
                                    "does not satisfy",
                ...
                a.dependencyParse = function (e) {
                    return l.isString(e)
                        ? (
                            /^[\w-]+(@(\*|[\^~]?\d+\.\d+\.\d+(-[0-9A-Za-z-]+)?))?$/.test(e) || l.warn("Plugin.dependencyParse:", e, "is not a valid dependency string."),
                            {
                                name: e.split("@")[0],
                                range: e.split("@")[1] || "*"
                            }
        ...
        21: [
            function (e, t, i) {
                ...
                !function () {
                    ...
                    (
                        "undefined" != typeof window && (
                            n = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame,
                    ...
                    s.tick = function (e, t, i) {
                        ...
                        e.isFixed
                            ...
                            : (
                                ...
                                s = (
                                    r = (
                                        r = (r = Math.min.apply(null, e.deltaHistory)) < e.deltaMin
                                            ? e.deltaMin
                                            : r
                                    ) > e.deltaMax
                                        ? e.deltaMax
                        ...
                        0 !== e.timeScalePrev && (s *= n.timeScale / e.timeScalePrev),
                        0 === n.timeScale && (s = 0),
                        e.timeScalePrev = n.timeScale,
                        e.correction = s,
                        e.frameCounter += 1,
                        1e3 <= i - e.counterTimestamp && (
                            e.fps = e.frameCounter * ((i - e.counterTimestamp) / 1e3),
                            e.counterTimestamp = i,
                            e.frameCounter = 0
                        ),
                        a.trigger(e, "tick", o),
                        a.trigger(t, "tick", o),
                        t.world.isModified && t.render && t.render.controller && t.render.controller.clear && t
                            .render
                            .controller
                            .clear(t.render),
        ...
        22: [
            function (e, t, i) {
                ...
                t.exports = h;
                var r = e("./Events");
                h._motionWakeThreshold = .18,
                h._motionSleepThreshold = .08,
                h._minBias = .9,
                h.update = function (e, t) {
                    for (var i = t * t * t, r = 0; r < e.length; r++) {
                        ...
                        if (0 === n.force.x && 0 === n.force.y) {
                            ...
                            0 < n.sleepThreshold && n.motion < h._motionSleepThreshold * i
                                ? (n.sleepCounter += 1, n.sleepCounter >= n.sleepThreshold && h.set(n, !0))
                ...
                h.set = function (e, t) {
                    ...
                    t
                        ...
                        : (e.isSleeping = !1, e.sleepCounter = 0, i && r.trigger(e, "sleepEnd"))
                }
            }, {
                "./Events": 16
            }
                ...
                g.fromVertices = function (e, t, i, r, n, s, o) {
                    ...
                    for (
                        ...
                        o = void 0 !== o
                            ...
                            : 10,
                        A || M.warn(
                            "Bodies.fromVertices: poly-decomp.js required. Could not decompose vertices. Fa" +
                            "llback to convex hull."
                        ),
                        M.isArray(i[0]) || (i = [i]),
                        g = 0; g < i.length; g += 1
                    ) 
                        if (h = i[g], (c = k.isConvex(h)) || !A) 
                            ...
                            A.makeCCW(m),
                            !1 !== s && A.removeCollinearPoints(m, s);
                            var v = A.quickDecomp(m);
                            for (d = 0; d < v.length; d++) {
                                var y = v[d].map(function (e) {
                                    return {x: e[0], y: e[1]}
                                });
                                0 < o && k.area(y) < o || l.push({position: k.centre(y), vertices: y})
                            }
                        }
        ...
        24: [
            function (e, t, i) {
                ...
                f.mesh = function (e, t, i, r, n) {
                    ...
                    for (s = 0; s < i; s++) {
                        for (o = 1; o < t; o++) 
                            a = h[o - 1 + s * t],
                            l = h[o + s * t],
                            y.addConstraint(e, p.create(m.extend({
                                bodyA: a,
                                bodyB: l
                            }, n)));
                        if (0 < s) 
                ...
                f.newtonsCradle = function (e, t, i, r, n) {
                    for (var s = y.create({label: "Newtons Cradle"}), o = 0; o < i; o++) {
        ...
        27: [
            function (e, t, i) {
                ...
                _.pathToVertices = function (e, t) {
                    "undefined" == typeof window || "SVGPathSeg" in window || x.warn(
                    ...
                    for (
                        ...
                        if (/[MLHVCSQTA]/.test(f)) 
                            ...
                            switch (
                                ...
                                case "a":
                                    a.replaceItem(
                                        e.createSVGPathSegArcAbs(l, c, u.r1, u.r2, u.angle, u.largeArcFlag, u.sweepFlag),
                                        d
                                    );
                                    break;
                                case "z":
        ...
        28: [
            function (e, t, i) {
                ...
                r.rotateAbout = function (e, t, i, r) {
                    ...
                    return r.y = i.y + ((e.x - i.x) * s + (e.y - i.y) * n),
                    r.x = o,
                    r
                },
            ...
            function (e, t, i) {
                ...
                a.fromPath = function (e, t) {
                    ...
                    return e.replace(/L?\s*([\-\d\.e]+)[\s,]*([\-\d\.e]+)*/gi, function (e, t, i) {
                        r.push({x: parseFloat(t), y: parseFloat(i)})
                    }),
                    a.create(r, t)
                },
                a.centre = function (e) {
                ...
                a.inertia = function (e, t) {
                    for (var i, r, n = 0, s = 0, o = e, a = 0; a < o.length; a++) 
                        r = (a + 1) % o.length,
                        n += (i = Math.abs(x.cross(o[r], o[a]))) * (
                            x.dot(o[r], o[r]) + x.dot(o[r], o[a]) + x.dot(o[a], o[a])
                        ),
                        s += i;
                    return t / 6 * (n / s)
                },
                ...
                a.hull = function (e) {
                    ...
                    for ((e = e.slice(0)).sort(function (e, t) {
                        ...
                        for (
                            t = e[i];
                            2 <= n.length && x.cross3(n[n.length - 2], n[n.length - 1], t) <= 0;
                        ) 
                            n.pop();
                        n.push(t)
                    }
                    for (i = e.length - 1; 0 <= i; i -= 1) {
                        for (
                            t = e[i];
                            2 <= r.length && x.cross3(r[r.length - 2], r[r.length - 1], t) <= 0;
                        ) 
                            r.pop();
                        r.push(t)
                    }
            ...
            function (e, t, i) {
                ...
                !function () {
                    var r,
                        t;
                    "undefined" != typeof window && (
                        r = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function (e) {
                    ...
                    x.create = function (e) {
                        ...
                        i.mouse = e.mouse,
                        i.engine = e.engine,
                        i.canvas = i.canvas || n(i.options.width, i.options.height),
                        i.context = i
                            .canvas
                            .getContext("2d"),
                        i.textures = {},
                        ...
                        1 !== i.options.pixelRatio && x.setPixelRatio(i, i.options.pixelRatio),
                        m.isElement(i.element)
                            ? i
                                .element
                                .appendChild(i.canvas)
                            : i.canvas.parentNode || m.log(
                                "Render.create: options.element was undefined, render.canvas was created but no" +
                                        "t appended",
                                "warn"
                            ),
                        i
                    ...
                    x.lookAt = function (e, t, i, r) {
                        ...
                        r && (
                            e.bounds.min.x += .5 * c - c * g * .5,
                            e.bounds.max.x += .5 * c - c * g * .5,
                            e.bounds.min.y += .5 * h - h * p * .5,
                            e.bounds.max.y += .5 * h - h * p * .5
                        ),
                        e.bounds.min.x -= i.x,
                        e.bounds.max.x -= i.x,
                        e.bounds.min.y -= i.y,
                        e.bounds.max.y -= i.y,
                        e.mouse && (k.setScale(e.mouse, {
                    ...
                    x.startViewTransform = function (e) {
                        ...
                        e
                            .context
                            .translate(-e.bounds.min.x, -e.bounds.min.y)
                    },
                    x.endViewTransform = function (e) {
                        e
                            .context
                            .setTransform(e.options.pixelRatio, 0, 0, e.options.pixelRatio, 0, 0)
                    },
                    x.world = function (e) {
                        var t,
                            i = e.engine,
                        ...
                        if (
                            ...
                            for (t = 0; t < l.length; t++) {
                                ...
                                v && y && ((w.contains(e.bounds, v) || w.contains(e.bounds, y)) && d.push(g))
                            }
                        ...
                        !o.wireframes || i.enableSleeping && o.showSleeping
                            ? x.bodies(e, h, s)
                            : (o.showConvexHulls && x.bodyConvexHulls(e, h, s), x.bodyWireframes(e, h, s)),
                        ...
                        x.constraints(d, s),
                        o.showBroadphase && i.broadphase.controller === C && x.grid(e, i.broadphase, s),
                    ...
                    x.debug = function (e, t) {
                        ...
                        if (500 <= r.timing.timestamp - (e.debugTimestamp || 0)) {
                            var a = "";
                            s.timing && (a += "fps: " + Math.round(s.timing.fps) + "    "),
                            e.debugString = a,
                                    ...
                                    if (
                                        ...
                                        for (
                                            ...
                                            c = f % 2 == 0
                                                ? 1
                                                : -1,
                                            i.lineTo(s.x + h.x * (f / u) + d.x * c * 4, s.y + h.y * (f / u) + d.y * c * 4);
                                i.lineTo(o.x, o.y)
                                }
                                n.render.lineWidth && (
                    ...
                    x.bodyShadows = function (e, t, i) {
                        for (var r = i, n = (e.engine, 0); n < t.length; n++) {
                            ...
                            if (s.render.visible) {
                                if (s.circleRadius) 
                                    r.beginPath(),
                                    r.arc(s.position.x, s.position.y, s.circleRadius, 0, 2 * Math.PI),
                                    r.closePath();
                                else {
                                    r.beginPath(),
                                ...
                                r.shadowOffsetX = .05 * a,
                                r.shadowOffsetY = .05 * l,
                        ...
                        for (s = 0; s < t.length; s++) 
                            if ((r = t[s]).render.visible) 
                                for (
                                    o = 1 < r.parts.length
                                        ? 1
                                        : 0; o < r.parts.length; o++
                                ) 
                                    if ((n = r.parts[o]).render.visible) {
                                        if (
                                            l.showSleeping && r.isSleeping
                                                ? a.globalAlpha = .5 * n.render.opacity
                                                : 1 !== n.render.opacity && (a.globalAlpha = n.render.opacity),
                                            n.render.sprite && n.render.sprite.texture && !l.wireframes
                                        ) {
                                            ...
                                            if (n.circleRadius) 
                                                a.beginPath(),
                                                a.arc(n.position.x, n.position.y, n.circleRadius, 0, 2 * Math.PI);
                                            else {
                                                a.beginPath(),
                                            ...
                                            l.wireframes
                                                ...
                                                : (a.fillStyle = n.render.fillStyle, n.render.lineWidth && (
                        ...
                        for (r = 0; r < t.length; r++) {
                            ...
                            for (
                                ...
                                for (n = 0; n < l.vertices.length; n++) 
                                    ...
                                    o.fillText(
                                        r + "_" + n,
                                        l.position.x + .8 * (l.vertices[n].x - l.position.x),
                                        l.position.y + .8 * (l.vertices[n].y - l.position.y)
                                    )
                            }
                        }
                    },
                        ...
                        for (a.beginPath(), s = 0; s < t.length; s++) 
                            if ((r = t[s]).render.visible) 
                                for (o = 0; o < r.parts.length; o++) 
                                    n = r.parts[o],
                                    a.arc(n.position.x, n.position.y, 3, 0, 2 * Math.PI, !1),
                                    a.closePath();
                    for (
                            l.wireframes
                            ...
                            (r = t[s]).render.visible && (
                                a.arc(r.positionPrev.x, r.positionPrev.y, 2, 0, 2 * Math.PI, !1),
                                a.closePath()
                            );
                    ...
                    x.bodyVelocity = function (e, t, i) {
                        ...
                        for (var n = 0; n < t.length; n++) {
                            var s = t[n];
                            s.render.visible && (r.moveTo(s.position.x, s.position.y), r.lineTo(
                        ...
                        for (r = 0; r < t.length; r++) 
                            if (t[r].render.visible) {
                                ...
                                for (
                                    ...
                                    s.fillText(a.id, a.position.x + 10, a.position.y - 10)
                                }
                            }
                        },
                    x.collisions = function (e, t, i) {
                        ...
                        for (a.beginPath(), s = 0; s < t.length; s++) 
                            ...
                            if ((r = t[s]).isActive && (n = r.collision, 0 < r.activeContacts.length)) {
                                var h = r
                                        .activeContacts[0]
                                        .vertex
                                        .x,
                                ...
                                2 === r.activeContacts.length && (
                                    h = (r.activeContacts[0].vertex.x + r.activeContacts[1].vertex.x) / 2,
                    ...
                    x.separations = function (e, t, i) {
                        ...
                        for (l.beginPath(), a = 0; a < t.length; a++) 
                            if ((r = t[a]).isActive) {
                                ...
                                var h = 1;
                                (o = n.bodyB).isStatic || s.isStatic || (h = .5),
                                o.isStatic && (h = 0),
                    ...
                    x.grid = function (e, t, i) {
                        ...
                        for (var n = m.keys(t.buckets), s = 0; s < n.length; s++) {
                            ...
                            if (!(t.buckets[o].length < 2)) {
                                var a = o.split(/C|R/);
                                r.rect(
                                    .5 + parseInt(a[1], 10) * t.bucketWidth,
                                    .5 + parseInt(a[2], 10) * t.bucketHeight,
                                    t.bucketWidth,
                                    t.bucketHeight
                                )
                            }
            ...
            function (e, t, i) {
                ...
                !function () {
                    ...
                    _.create = function (e) {
                        ...
                        i.mouse = e.mouse,
                        i.engine = e.engine,
                        i.renderer = i.renderer || new PIXI.WebGLRenderer(
                            i.options.width,
                            i.options.height,
                            i.pixiOptions
                        ),
                    ...
                    _.setBackground = function (e, t) {
                        if (e.currentBackground !== t) {
                            ...
                            if (i) {
                                ...
                                var s = o(e, t);
                                (r = e.sprites["bg-0"] = new PIXI.Sprite(s)).position.x = 0,
                                r.position.y = 0,
                                e
                                    .container
                                    .addChildAt(r, 0)
                    ...
                    _.world = function (e) {
                        ...
                        if (s.hasBounds) {
                            ...
                            for (t = 0; t < a.length; t++) {
                                ...
                                v && y && ((x.contains(e.bounds, v) || x.contains(e.bounds, y)) && l.push(g))
                            }
                            n
                                .scale
                                .set(1 / d, 1 / u),
                            n
                                .position
                                .set(-e.bounds.min.x * (1 / d), -e.bounds.min.y * (1 / u))
                        } else 
                            l = a;
                        for (t = 0; t < o.length; t++) 
                            _.body(e, o[t]);
                    ...
                    _.constraint = function (e, t) {
                        ...
                        a.visible && t.pointA && t.pointB
                            ? (
                                ...
                                c.clear(),
                                c.beginFill(0, 0),
                                c.lineStyle(a.lineWidth, f.colorToNumber(a.strokeStyle), 1),
                                i
                    ...
                    _.body = function (e, t) {
                        ...
                        if (i.visible) 
                            ...
                            var o = "b-" + t.id,
                                a = e.primitives[o],
                                l = e.container;
                            a || ((a = e.primitives[o] = h(e, t)).initialAngle = t.angle),
                    ...
                    var c = function (e, t) {
                            var i = t.render.sprite.texture,
                                r = o(e, i),
                                n = new PIXI.Sprite(r);
                            return n.anchor.x = t.render.sprite.xOffset,
                        ...
                        h = function (e, t) {
                            ...
                            s.clear();
                            for (
                                var d = 1 < t.parts.length
                                    ? 1
                                    : 0; d < t.parts.length; d++
                            ) {
                                i = t.parts[d],
                                n.wireframes
                                    ? (s.beginFill(0, 0), s.lineStyle(1, c, 1))
                                    : (s.beginFill(o, 1), s.lineStyle(r.lineWidth, a, 1)),
                                s.moveTo(i.vertices[0].x - t.position.x, i.vertices[0].y - t.position.y);
                                for (var u = 1; u < i.vertices.length; u++) 
                                    s.lineTo(i.vertices[u].x - t.position.x, i.vertices[u].y - t.position.y);
                                s.lineTo(i.vertices[0].x - t.position.x, i.vertices[0].y - t.position.y),
                                s.endFill(),
                                (n.showAngleIndicator || n.showAxes) && (
                                    ...
                                    n.wireframes
                                        ? s.lineStyle(1, h, 1)
                                        : s.lineStyle(1, l),
                                    s.moveTo(i.position.x - t.position.x, i.position.y - t.position.y),
                                    s.lineTo(
                                        (i.vertices[0].x + i.vertices[i.vertices.length - 1].x) / 2 - t.position.x,
                                        (i.vertices[0].y + i.vertices[i.vertices.length - 1].y) / 2 - t.position.y
                                    ),
                                    s.endFill()
                                )
                            }
...
Matter.World.add(
    solver.world,
    [bounds.left.entity, bounds.right.entity, bounds.bottom.entity]
);
var defaultStyles = {
    size: getFontSize(),
    weight: 400,
    color: "black",
    leading: getFontSize(),
    family: "akzidenz_ex_rg, Helvetica Neue, sans-serif",
    margin: {
        top: 5,
        left: 10,
        right: 15,
...
function setup() {
    ...
    window.addEventListener("deviceorientation", function (e) {
        var t = void 0 !== window.orientation
                ? window.orientation
                : 0,
            i = solver.world.gravity;
        0 === t
            ? (i.x = clamp(e.gamma, -90, 90) / 90, i.y = clamp(e.beta, -90, 90) / 90)
            : 180 === t
                ? (i.x = clamp(e.gamma, -90, 90) / 90, i.y = clamp(-e.beta, -90, 90) / 90)
                : 90 === t
                    ? (i.x = clamp(e.beta, -90, 90) / 90, i.y = clamp(-e.gamma, -90, 90) / 90)
                    : -90 === t && (
...
function setupCopy() {
    ...
    function a(e) {
        ...
        if (0 < e.childNodes.length) {
            ...
            for (s.push({styles: o, value: []}), i = 0; i < e.childNodes.length; i++) 
                t = a(e.childNodes[i]),
                s[0].value = s[0]
                    .value
                    .concat(t)
...
function resize() {
    ...
    Matter
        .Body
        .setPosition(bounds.left.entity, vector),
    Matter
        .Body
        .scale(
            bounds.left.entity,
    ...
    Matter
        .Body
        .setPosition(bounds.right.entity, vector),
    Matter
        .Body
        .scale(
            bounds.right.entity,
    ...
    Matter
        .Body
        .setPosition(bounds.bottom.entity, vector),
    Matter
        .Body
        .scale(
    ...
    Matter
        .Body
        .scale(bounds.bottom.entity, t, e),
    bounds.bottom.entity.scale.x = t,
    bounds.bottom.entity.scale.y = e,
    two
        .renderer
        .domElement
        .setAttribute("data-pixel-ratio", two.renderer.ratio);
    for (
        var r = getFontSize(),
        n = .8 * r,
        s = 0;
    ...
    for (var e = 0; e < entities.length; e++) {
        ...
        if (
            ...
            r < .01 && -.01 < r
                ...
                : i.scale += .66 * (i.destinationScale - i.scale)
        }
    }
    two.render()
}
function addSlogan() {
    for (
        ...
        two.width < r && (
            ...
            l.index++,
            l.push({width: defaultStyles.margin.left, index: c}),
            o = defaultStyles.margin.left,
            a += defaultStyles.leading + defaultStyles.margin.top + defaultStyles.margin.bottom,
            e = o + i.width / 2,
            t = a + i.height / 2
        ),
        d.translation.x = e,
        ...
        Matter
            .Body
            .scale(p, i.width, i.height),
        Matter
            .Body
            .rotate(p, Math.random() * Math.PI / 16 - Math.PI / 32),
...
function addMouseInteraction() {
    ...
    r.addEventListener("mousedown", function (e) {
        ...
        a = e.clientY < t.bottom,
        o = !1,
        i = null
    }, !1),
    r.addEventListener("touchstart", function (e) {
        var t = l.getBoundingClientRect();
        (a = !!(e.touches && 0 < e.touches.length) && e.touches[0].clientY < t.bottom)
            ? d()
            : h || (
                n.mousedown(e),
    ...
    Matter
        .Events
        .on(e, "mousedown", function (e) {
            a || !i && symbols.isReady && injectSymbol(n.position)
        }),
    Matter
        .Events
        .on(e, "startdrag", function (e) {
            if (!a && (i = e.source.body, o)) {
                var t = Date.now();
                t - s <= 300 && i && (cascade(n.position), explode(i)),
                s = t
            }
        }),
    Matter
    ...
    if (!e.object.isSymbol) {
        ...
        for (var a = 0; a < i.length; a++) {
            ...
            Matter
                ...
                .setMass(e, 2.5);
            var v = l * Math.PI * 2;
            vector.x = .33 * Math.cos(v),
            vector.y = .33 * Math.sin(v),
            Matter
                .Body
                .applyForce(e, e.position, vector),
...
function getPathFromSVG(e) {
    for (var t = 0; t < e.children.length; t++) {
        var i = e.children[t];
        if (/path/i.test(i._renderer.type)) 
            return i
    }
    return null
}
function getNextSymbol() {
    ...
    return symbols.index = (symbols.index + 1) % symbols.length,
    e.isReady
        ? e
        : getNextSymbol()
}
function cascade(e) {
    for (var t = 0; t < entities.length; t++) {
        ...
        Matter
            .Body
            .applyForce(i, i.position, vector)
    }
}
function release(e) {
    vector.x = 0,
...
function createBoundary(e, t) {
    ...
    var r = Matter
        .Bodies
        .rectangle(0, 0, 1, 1, bounds.properties);
    return Matter
        .Body
        .scale(r, e, t),
